...
func (x *TokenRes) GetAccessToken() string {
	if x != nil {
...
func (x *TokenRes) GetRefreshToken() string {
	if x != nil {
...
var file_common1_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x16, 0x0a, 0x04, 0x42, 0x79, 0x49, 0x64, 0x12, 0x0e, 0x0a,
	...
	0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0x06, 0x0a, 0x04, 0x56, 0x6f, 0x69, 0x64, 0x22, 0x62, 0x0a,
	0x08, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x6e, 0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x75,
...
var file_common1_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_common1_proto_goTypes = []interface{}{
	(*ById)(nil),     // 0: auth.ById
	(*Filter)(nil),   // 1: auth.Filter
	(*Void)(nil),     // 2: auth.Void
